...
const PaymentsForm = ({ formData, handleChange, handleStudent, handleConcept, handleDivision, handleAmount, handleDate, onSubmit, isLoading, concepts, divisions, students, months }) => {
